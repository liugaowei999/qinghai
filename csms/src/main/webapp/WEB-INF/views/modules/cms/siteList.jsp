...
<body>
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead><tr><th>名称</th><th>标题</th><th>描述</th><th>关键字</th><th>主题</th><th>是否为默认站点</th><shiro:hasPermission name="cms:site:edit"><th>操作</th></shiro:hasPermission></tr></thead>
		<tbody>
		<c:forEach items="${page.list}" var="site">
			<tr>
				...
				<shiro:hasPermission name="cms:site:edit"><td>
					...
					<a href="${ctx}/cms/site/default?id=${site.id}">设为默认</a>
