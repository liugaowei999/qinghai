...
<head>
	...
	<link href="${ctxStatic}/modules/cms/front/themes/sol/css/listPage.css" type="text/css" rel="stylesheet" />
						...
						<div class="right-list">
						  <c:if test="${category.module eq 'article'}">
							<ul><c:forEach items="${page.list}" var="article">
								<li class="list-item"><span class="pull-right"><fmt:formatDate value="${article.updateDate}" pattern="yyyy.MM.dd"/></span><a href="${article.url}" style="color:${article.color}">${fns:abbr(article.title,96)}</a></li>
							</c:forEach></ul>
