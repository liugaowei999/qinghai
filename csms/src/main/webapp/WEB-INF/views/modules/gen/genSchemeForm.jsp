	...
	<form:form id="inputForm" modelAttribute="genScheme" action="${ctx}/gen/genScheme/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				...
				<span class="help-inline">建议模块包：com.cttic.csms.modules</span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">列表风格:</label>
			<div class="controls">
				<!-- 拿备注信息对列表风格进行扩展 -->
				<form:radiobutton path="remarks" value="1" label="easyui风格" />
				<form:radiobutton path="remarks" value="0" label="默认风格" checked="true" />
			</div>
		</div>
