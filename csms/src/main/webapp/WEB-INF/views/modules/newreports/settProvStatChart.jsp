...
function pieViewChart(){
	...
	$.ajax({
		url : '${ctx}/newreports/settProvStat/provStatSumViewChart',
		method : "post",
		data : {
			settCycle:settDate
		},
...
function allYearLineChart(){
	 var settDate = $("#settDate4").val();
		if(settDate==null||settDate==''){
			settDate = currentYear;
		}
		$.ajax({
			url : '${ctx}/newreports/settProvStat/allYearLineChart',
			method : "post",
			data : {
				settCycle:settDate
			},
...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/newreports/settProvStat/settProvStatList">跨省月结算列表</a></li>
		<li class="active"><a href="${ctx}/newreports/settProvStat/settProvStatChart">图表展示</a></li>
	</ul><br/>
	<div class="chart-list-panel">
			<div class="row">
				 <div class="col-md-6">
					<div class="chart">
					 <form:form modelAttribute="settProvStatReport"  method="post" class="breadcrumb form-search">
					...
					<div class="chart">
					 <form:form modelAttribute="settStatReport"  method="post" class="breadcrumb form-search">
				 		...
				 		<ul class="ul-form">
				 			...
				 			<li>
							<a href="#" onClick="allYearLineChart()" class="btn btn-primary" >查看</a>
							</li>
				 			<li class="clearfix"></li>
				 		</ul>
				 		</form:form>		
