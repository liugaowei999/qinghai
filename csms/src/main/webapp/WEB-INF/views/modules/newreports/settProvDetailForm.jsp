...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/newreports/settProvDetail/">跨省结算详单展示列表</a></li>
		<li class="active"><a href="${ctx}/newreports/settProvDetail/form?id=${settProvDetail.id}">跨省结算详单展示<shiro:hasPermission name="newreports:settProvDetail:edit">${not empty settProvDetail.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="newreports:settProvDetail:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="settProvDetail" action="${ctx}/newreports/settProvDetail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="settDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${settProvDetail.settDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="newreports:settProvDetail:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
