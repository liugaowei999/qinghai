...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/newreports/settProvDaily/">跨省日统计报表列表</a></li>
		<li class="active"><a href="${ctx}/newreports/settProvDaily/form?id=${settProvDaily.id}">跨省日统计报表<shiro:hasPermission name="newreports:settProvDaily:edit">${not empty settProvDaily.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="newreports:settProvDaily:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="settProvDaily" action="${ctx}/newreports/settProvDaily/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="settDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${settProvDaily.settDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="newreports:settProvDaily:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
