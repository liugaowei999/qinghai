	...
	<div class="chart-list-panel">
			...
			<div class="col-md-6">
				<div class="chart">
					<form:form modelAttribute="settProvStatDetail" method="post"
						...
						<label class="chart-title">跨省-各结算费用占比</label>
						<ul class="ul-form">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="chart">
					...
					<form:form method="post" class="breadcrumb form-search">
						<label class="chart-title">跨省-各发卡机构结算费用对比</label>
						<ul class="ul-form">
			...
			<div class="col-md-6">
				<div class="chart">
					...
					<form:form modelAttribute="settProvStatDetail" method="post"
						class="breadcrumb form-search">
						<label class="chart-title">跨省-各发卡机构结算费用月趋势图</label>
						<ul class="ul-form">
							...
							<a href="#" onClick="issueCodeProvLineChart()"
								class="btn btn-primary">查看</a></li>
							<li class="clearfix"></li>
						</ul>
					</form:form>
		...
		<div class="row">
			<div class="col-md-6">
				<div class="chart">
					<form:form method="post" class="breadcrumb form-search">
						<label class="chart-title">跨省-各收单机构结算费用对比</label>
						<ul class="ul-form">
			...
			<div class="col-md-6">
				<div class="chart">
					<form:form modelAttribute="settProvStatDetail" method="post"
						class="breadcrumb form-search">
						<label class="chart-title">跨省-各收单机构结算费用月趋势图</label>
						<ul class="ul-form">
							...
							<a href="#" onClick="billCodeProvLineChart()"
								class="btn btn-primary">查看</a></li>
							<li class="clearfix"></li>
						</ul>
					</form:form>
