...
<script type="text/javascript">
	...
	function billCodeEcharts(pieData) {
	...
	<div class="chart-list-panel">
			...
			<div class="col-md-6">
				<div class="chart">
					...
					<form:form method="post" class="breadcrumb form-search">
						<label class="chart-title">本地-各发卡机构结算费用月统计</label>
						<ul class="ul-form">
			...
			<div class="col-md-6">
				<div class="chart">
					...
					<form:form modelAttribute="settCityStatDetail" method="post"
						...
						<label class="chart-title">本地-发卡机构结算费用月趋势图</label>
						<ul class="ul-form">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="chart">
					<form:form method="post" class="breadcrumb form-search">
						<label class="chart-title">本地-收单机构结算费用月统计</label>
						<ul class="ul-form">
