...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/reports/settProvStatDetail/form?id=${settProvStatDetail.id}">记录<shiro:hasPermission name="reports:settProvStatDetail:edit">${not empty settProvStatDetail.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="reports:settProvStatDetail:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="settProvStatDetail" action="${ctx}/reports/settProvStatDetail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="settDate" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${settProvStatDetail.settDate}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="control-group">
			...
			<div class="controls">
				<sys:treeselect id="settOrgCode" name="settOrgCode" value="${settProvStatDetail.settOrgCode}" labelName="" labelValue="${settProvStatDetail.}"
		...
		<div class="form-actions">
			<shiro:hasPermission name="reports:settProvStatDetail:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
