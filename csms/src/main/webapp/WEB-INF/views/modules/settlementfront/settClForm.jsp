...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/settlementfront/settCl/">发卡消费明细列表</a></li>
		<li class="active"><a href="${ctx}/settlementfront/settCl/form?id=${settCl.id}">记录<shiro:hasPermission name="settlementfront:settCl:edit">${not empty settCl.id?'详情':'添加'}</shiro:hasPermission><shiro:lacksPermission name="settlementfront:settCl:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="settCl" action="${ctx}/settlementfront/settCl/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			<label class="control-label">余额类型：</label>
			<div class="controls">
				<form:input path="balanceType" htmlEscape="false" maxlength="1" class="input-xlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">算法标识：</label>
			<div class="controls">
				<form:input path="algorithmId" htmlEscape="false" maxlength="2" class="input-xlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="reserved" htmlEscape="false" maxlength="28" class="input-xlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">验证数据：</label>
			<div class="controls">
				<form:input path="tlvData" htmlEscape="false" maxlength="1024" class="input-xlarge " disabled="true"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="form-actions">
			<%-- <shiro:hasPermission name="settlementfront:settCl:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission> --%>
