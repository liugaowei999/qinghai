...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/settlementfront/erBillDetail/">省内地市结算异常记录列表</a></li>
		<li class="active"><a href="${ctx}/settlementfront/erBillDetail/form?id=${erBillDetail.id}">省内地市结算异常记录<shiro:hasPermission name="settlementfront:erBillDetail:edit">${not empty erBillDetail.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="settlementfront:erBillDetail:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="erBillDetail" action="${ctx}/settlementfront/erBillDetail/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="indbTime" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${erBillDetail.indbTime}" pattern="yyyy-MM-dd HH:mm:ss"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="settlementfront:erBillDetail:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
