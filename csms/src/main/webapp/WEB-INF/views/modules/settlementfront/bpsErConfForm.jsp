...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/settlementfront/bpsErConf/">ER错误代码下发配置文件列表</a></li>
		<li class="active"><a href="${ctx}/settlementfront/bpsErConf/form?id=${bpsErConf.id}">ER错误代码下发配置文件<shiro:hasPermission name="settlementfront:bpsErConf:edit">${not empty bpsErConf.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="settlementfront:bpsErConf:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="bpsErConf" action="${ctx}/settlementfront/bpsErConf/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="settlementfront:bpsErConf:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
