 ...
 * @version 2016-12-22
 */
public class SettProvStatDetail extends DataEntity<SettProvStatDetail> {
	...
	private Double issueCharge;		// 发卡元润
	private Double billCharge;		// 收单元润
	private Double centerCharge;		// 清算中心元润
	...
	public SettProvStatDetail() {
		super();
	}

	public SettProvStatDetail(String id){
		super(id);
	}
