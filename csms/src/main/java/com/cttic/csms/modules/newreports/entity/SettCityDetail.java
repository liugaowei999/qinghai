 ...
 * @version 2017-03-07
 */
public class SettCityDetail extends DataEntity<SettCityDetail> {
	...
	private String settOrgCode;
	private String roamType;
	private String roamTypeName;

	private DecimalFormat df = new DecimalFormat("##############.#################");

	public SettCityDetail() {
		super();
	}

	public SettCityDetail(String id) {
		super(id);
	}
	...
	@ExcelField(title = "漫游类型", align = 2, sort = 4)
	public String getRoamTypeName() {
		return roamTypeName;
	}

	public void setRoamTypeName(String roamTypeName) {
		this.roamTypeName = roamTypeName;
	}
	...
	@ExcelField(title = "消费前金额(元)", align = 2, sort = 8)
	...
	@ExcelField(title = "消费金额(元)", align = 2, sort = 9)
	...
	@ExcelField(title = "消费日期", align = 2, sort = 10)
	...
	@ExcelField(title = "消费时间", align = 2, sort = 11)
	...
	@ExcelField(title = "手续费(元)", align = 2, sort = 12)
	...
	@ExcelField(title = "发卡分润(元)", align = 2, sort = 13)
	...
	@ExcelField(title = "收单分润(元)", align = 2, sort = 14)
	...
	@ExcelField(title = "清算中心分润(元)", align = 2, sort = 15)
	...
	@ExcelField(title = "结算金额(元)", align = 2, sort = 16)
