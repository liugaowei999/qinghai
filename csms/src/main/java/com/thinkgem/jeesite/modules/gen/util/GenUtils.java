...
//		}
	...
	/**
	 * 根据列表风格，获取代码生成配置对象
	 * @param datatableStyle
	 * @return
	 */
	public static GenConfig getConfig(String datatableStyle){
		String xmlFile = "config.xml";
		if(Global.STYLE_EASYUI.equals(datatableStyle)) {
			xmlFile = "config-easyui.xml";
		} 
		return fileToObject(xmlFile, GenConfig.class);
	}
