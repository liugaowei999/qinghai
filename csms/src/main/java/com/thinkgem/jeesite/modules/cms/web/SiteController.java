...
public class SiteController extends BaseController {
	...
	public String setdefault(Site site, @RequestParam(required=false) Boolean isRe, RedirectAttributes redirectAttributes) {
		if(Global.isDemoMode()){
			addMessage(redirectAttributes, "演示模式，不允许操作！");
			return "redirect:" + adminPath + "/cms/site/?repage";
		}
		CacheUtils.put(CmsUtils.DEFAULT_SITE, site.getId());
		addMessage(redirectAttributes, (isRe!=null&&isRe?"恢复":"")+"设置默认站点成功");
		return "redirect:" + adminPath + "/cms/site/?repage";
	}
