...
public class CmsUtils {
	...
	public static final String ARTICLE_HIT_COUNT = "ARTICLE_HIT_COUNT";
	...
	public static List<Category> getMainNavList(String siteId){
		@SuppressWarnings("unchecked")
		String navKey = "mainNavList_"+siteId;
		List<Category> mainNavList = (List<Category>)CacheUtils.get(CMS_CACHE, navKey);
		if (mainNavList == null){
