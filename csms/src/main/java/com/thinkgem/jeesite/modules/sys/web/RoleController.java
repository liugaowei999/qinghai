...
public class RoleController extends BaseController {
	...
	public String form(Role role, Model model,String id) {
	...
	public String save(Role role, Model model,String id, RedirectAttributes redirectAttributes) {
	...
	public String delete(Role role, RedirectAttributes redirectAttributes,String id) {
		role = systemService.getRole(id);
		if(!UserUtils.getUser().isAdmin() && role.getSysData().equals(Global.YES)){
			addMessage(redirectAttributes, "越权操作，只有超级管理员才能修改此数据！");
			return "redirect:" + adminPath + "/sys/role/?repage";
...
//		}
	...
	public String assign(Role role, Model model,String id) {
